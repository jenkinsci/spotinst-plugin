...
public interface IAzureGroupRepo {
    ApiResponse<List<AzureGroupInstance>> getGroupInstances(String groupId, String accountId, Secret token);

    ApiResponse<Boolean> detachInstance(String groupId, String instanceId, String accountId, Secret token);

    ApiResponse<Boolean> scaleUp(String groupId, Integer adjustment, String accountId, Secret token);
}
